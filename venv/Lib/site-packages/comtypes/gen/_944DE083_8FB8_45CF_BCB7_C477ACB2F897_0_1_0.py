...
__all__ = [
    'UIA_ItemTypePropertyId', 'UIA_BulletStyleAttributeId',
    'UIA_SayAsInterpretAsMetadataId', 'IUIAutomationOrCondition',
    'SynchronizedInputType_LeftMouseUp',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId', 'ZoomUnit',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_AsyncContentLoadedEventId', 'UIA_SpreadsheetPatternId',
    'ZoomUnit_SmallDecrement', 'ProviderOptions_UseClientCoordinates',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_ClassNamePropertyId', 'IUIAutomationInvokePattern',
    'UIA_AutomationPropertyChangedEventId',
    'UIA_ItemStatusPropertyId', 'UIA_ImageControlTypeId',
    'IUIAutomationProxyFactoryMapping',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_MainLandmarkTypeId', 'UIA_ControlTypePropertyId',
    'UIA_AriaPropertiesPropertyId', 'TreeTraversalOptions_PostOrder',
    'ScrollAmount_LargeDecrement',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'OrientationType_None', 'TextEditChangeType',
    'TreeTraversalOptions_Default',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_TableColumnHeadersPropertyId', 'IUIAutomationTextRange2',
    'UIA_TablePatternId', 'IUIAutomationSelectionPattern',
    'UIA_ToolBarControlTypeId', 'StyleId_Heading1',
    'IUIAutomationScrollPattern', 'UIA_TextChildPatternId',
    'IUIAutomationItemContainerPattern',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_ToolTipControlTypeId',
    'AnnotationType_CircularReferenceError',
    'IUIAutomationSpreadsheetPattern',
    'UIA_ProviderDescriptionPropertyId', 'UIA_FlowsFromPropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_VisualEffectsPropertyId',
    'ConnectionRecoveryBehaviorOptions', 'StructureChangeType',
    'UIA_RangeValueMinimumPropertyId', 'UIA_SelectionItemPatternId',
    'IUIAutomationElement3', 'UIA_EditControlTypeId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_AnnotationAuthorPropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_RangeValueSmallChangePropertyId', 'HeadingLevel6',
    'UIA_LocalizedLandmarkTypePropertyId', 'NotificationKind_Other',
    'UIA_UnderlineColorAttributeId', 'UIA_IsReadOnlyAttributeId',
    'UIA_SelectionPattern2Id', 'AnnotationType_GrammarError',
    'UIA_SemanticZoomControlTypeId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_MenuOpenedEventId', 'WindowVisualState_Normal',
    'UIA_Selection2ItemCountPropertyId', 'UIA_SearchLandmarkTypeId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_CapStyleAttributeId',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'WindowVisualState',
    'UIA_SizePropertyId', 'UIA_ScrollVerticalScrollPercentPropertyId',
    'OrientationType', 'UIA_ValuePatternId',
    'UIA_BoundingRectanglePropertyId', 'UIA_HyperlinkControlTypeId',
    'NavigateDirection_Parent', 'ScrollAmount_SmallIncrement',
    'UIA_DockDockPositionPropertyId', 'AnnotationType_Footer',
    'ToggleState', 'UIA_TextPattern2Id',
    'UIA_LegacyIAccessibleNamePropertyId', 'StyleId_Subtitle',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'IUIAutomationLegacyIAccessiblePattern', 'IUIAutomation5',
    ...
    'UIA_GridItemContainingGridPropertyId', 'UIA_DropTargetPatternId',
    'ZoomUnit_LargeDecrement', 'ProviderOptions_OverrideProvider',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'AnnotationType_Highlighted', 'UIA_CheckBoxControlTypeId',
    'UIA_AnimationStyleAttributeId',
    'AnnotationType_DataValidationError', 'UIA_TabItemControlTypeId',
    'HeadingLevel3', 'ProviderOptions_UseComThreading',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_LinkAttributeId', 'IUIAutomationCustomNavigationPattern',
    'UIA_TransformCanRotatePropertyId', 'UIA_CalendarControlTypeId',
    'UIA_NavigationLandmarkTypeId', 'RowOrColumnMajor_RowMajor',
    'IUIAutomationElement8', 'UIA_IsEnabledPropertyId',
    'SupportedTextSelection_Multiple',
    'SynchronizedInputType_KeyDown', 'UIA_DockPatternId',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_IsSubscriptAttributeId',
    'IUIAutomationTextChildPattern',
    'UIA_IndentationLeadingAttributeId',
    'NotificationKind_ActionCompleted', 'DockPosition_Fill',
    'IUIAutomationElement2', 'UIA_ScrollPatternId',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'AnnotationType_TrackChanges', 'StyleId_Heading8',
    ...
    'NavigateDirection', 'UIA_AcceleratorKeyPropertyId', 'TextUnit',
    'IUIAutomationDragPattern', 'UIA_GridItemColumnSpanPropertyId',
    'IUIAutomation4',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'ToggleState_Indeterminate', 'UIA_ExpandCollapsePatternId',
    'UIA_DataGridControlTypeId', 'UIA_HeadingLevelPropertyId',
    'ScrollAmount_SmallDecrement', 'TreeTraversalOptions',
    'UIA_CaretBidiModeAttributeId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_ListControlTypeId', 'NotificationKind',
    'NotificationProcessing_ImportantAll',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_MarginBottomAttributeId', 'IUIAutomationRangeValuePattern',
    'ScrollAmount_LargeIncrement',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'SupportedTextSelection_None',
    'UIA_IsWindowPatternAvailablePropertyId', 'SynchronizedInputType',
    'AnnotationType_Footnote', 'UIA_IsControlElementPropertyId',
    'IUIAutomationElement7', 'UIA_OutlineStylesAttributeId',
    ...
    'UIA_AnnotationTargetPropertyId', 'UIA_ValueIsReadOnlyPropertyId',
    'ExpandCollapseState_Collapsed', 'UIA_ValueValuePropertyId',
    'DockPosition_Bottom', 'LiveSetting',
    'IUIAutomationPropertyCondition',
    'UIA_OutlineThicknessPropertyId', 'IUIAutomationTreeWalker',
    'StyleId_BulletedList', 'UIA_SelectionPatternId',
    'UIA_IsDialogPropertyId', 'IUIAutomationWindowPattern',
    'UIA_OutlineColorPropertyId', 'UIA_ChangesEventId',
    'UIA_GridItemPatternId', 'IUIAutomationElement6',
    'UIA_RangeValueMaximumPropertyId',
    'AnnotationType_InsertionChange', 'UIA_CustomLandmarkTypeId',
    'OrientationType_Vertical', 'AnnotationType_SpellingError',
    'IUIAutomationMultipleViewPattern', 'UIA_GridRowCountPropertyId',
    'AnnotationType_FormulaError', 'AnnotationType_Sensitive',
    'UIA_MenuItemControlTypeId', 'UIA_DescribedByPropertyId', 'Off',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_AccessKeyPropertyId', 'IUIAutomationSpreadsheetItemPattern',
    'UIA_DragDropEffectPropertyId', 'TreeScope', 'ToggleState_Off',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_DropTargetDropTargetEffectsPropertyId', 'Polite',
    'UIA_TableControlTypeId', 'UIA_InputReachedTargetEventId',
    'UIA_PaneControlTypeId', 'PropertyConditionFlags',
    'SupportedTextSelection_Single', 'IUIAutomation6',
    'UIA_IndentationFirstLineAttributeId',
    'NavigateDirection_FirstChild', 'HeadingLevel7',
    'UIA_OptimizeForVisualContentPropertyId', 'TextUnit_Line',
    'UIA_TableRowOrColumnMajorPropertyId',
    'IUIAutomationTransformPattern2',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'IUIAutomationAnnotationPattern', 'AnnotationType_Mathematics',
    'UIA_SummaryChangeId', 'IUIAutomationTextRange',
    'IUIAutomationNotCondition', 'UIA_StylesShapePropertyId',
    'UIA_Selection2LastSelectedItemPropertyId', 'StyleId_Heading2',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_AriaRolePropertyId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_LandmarkTypePropertyId', 'UIA_StructureChangedEventId',
    'IUIAutomationEventHandlerGroup', 'ScrollAmount',
    'AnnotationType_Unknown', 'UIA_ObjectModelPatternId',
    'UIA_IsDataValidForFormPropertyId', 'ZoomUnit_LargeIncrement',
    'UIA_IsStylesPatternAvailablePropertyId',
    'IUIAutomationSelectionItemPattern',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_CustomNavigationPatternId', 'UIA_LiveRegionChangedEventId',
    'StyleId_Custom', 'TextEditChangeType_CompositionFinalized',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_CaretPositionAttributeId', 'TextEditChangeType_AutoCorrect',
    'UIA_TableItemPatternId', 'UIA_ComboBoxControlTypeId',
    'IUIAutomationTextPattern2',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_IsPeripheralPropertyId', 'UIA_FillTypePropertyId',
    'UIA_MenuModeEndEventId', 'UIA_HelpTextPropertyId',
    'UIA_IsPasswordPropertyId', 'UIA_TabControlTypeId',
    'UIA_CustomControlTypeId', 'UIA_GroupControlTypeId',
    'IUIAutomationElement', 'UIA_TogglePatternId', 'StyleId_Quote',
    'IUIAutomation3', 'UIA_LiveSettingPropertyId', 'HeadingLevel8',
    'UIA_DropTarget_DragEnterEventId', 'IAccessible',
    'UIA_WindowCanMinimizePropertyId',
    'UIA_DropTarget_DragLeaveEventId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'IUIAutomationValuePattern', 'DockPosition_Right',
    'UIA_IsSuperscriptAttributeId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_FontNameAttributeId', 'UIA_FontWeightAttributeId',
    'IUIAutomationObjectModelPattern', 'UIA_OverlineColorAttributeId',
    'UIA_Drag_DragCompleteEventId',
    'UIA_StylesFillPatternStylePropertyId', 'DockPosition_Left',
    'IUIAutomationTextEditPattern', 'UIA_Drag_DragStartEventId',
    ...
    'SynchronizedInputType_LeftMouseDown', 'UIA_FontSizeAttributeId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_AnnotationDateTimePropertyId',
    'UIA_StylesStyleNamePropertyId', 'AnnotationType_DeletionChange',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'ExpandCollapseState', 'UIA_SelectionSelectionPropertyId',
    'UIA_WindowIsTopmostPropertyId', 'TreeScope_Subtree',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_FormLandmarkTypeId', 'CUIAutomation8',
    'NavigateDirection_PreviousSibling',
    'UIA_HorizontalTextAlignmentAttributeId',
    'IUIAutomationSelectionPattern2', 'HeadingLevel4',
    'IUIAutomationNotificationEventHandler',
    'ProviderOptions_ClientSideProvider', 'UIA_Invoke_InvokedEventId',
    'UIA_LayoutInvalidatedEventId', 'UIA_SynchronizedInputPatternId',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_LineSpacingAttributeId', 'UIA_GridItemRowSpanPropertyId',
    'UIA_CulturePropertyId', 'TextUnit_Format',
    'ProviderOptions_NonClientAreaProvider', 'IUIAutomation2',
    'IUIAutomationGridPattern', 'UIA_SpreadsheetItemPatternId',
    'AnnotationType_Comment', 'IUIAutomationExpandCollapsePattern',
    'UIA_MenuModeStartEventId', 'TextPatternRangeEndpoint',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_DragDropEffectsPropertyId', 'UIA_ProcessIdPropertyId',
    'UIA_TextFlowDirectionsAttributeId',
    'UIA_ForegroundColorAttributeId', 'UIA_SizeOfSetPropertyId',
    'NavigateDirection_LastChild', 'RowOrColumnMajor_Indeterminate',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_GridItemRowPropertyId', 'UIA_AutomationIdPropertyId',
    'TextEditChangeType_None', 'NotificationProcessing',
    'UIA_ScrollBarControlTypeId', 'UIA_ScrollItemPatternId',
    'UIA_AfterParagraphSpacingAttributeId',
    'AutomationElementMode_Full', 'TreeScope_Parent',
    'ZoomUnit_NoAmount', 'StyleId_Heading7',
    'UIA_InputDiscardedEventId', 'IUIAutomation',
    'UIA_StylesPatternId', 'UIA_StyleNameAttributeId',
    'UIA_StyleIdAttributeId', 'UIA_SelectionActiveEndAttributeId',
    'UIA_WindowControlTypeId', 'UIA_RangeValueLargeChangePropertyId',
    'TextUnit_Paragraph',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_UnderlineStyleAttributeId', 'UIA_TextEditPatternId',
    'UIA_NamePropertyId', 'UIA_WindowCanMaximizePropertyId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'IUIAutomationElementArray',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_IsTablePatternAvailablePropertyId',
    'UIA_ProgressBarControlTypeId', 'UIA_MultipleViewPatternId',
    ...
    'StyleId_Heading4', 'ExpandCollapseState_LeafNode',
    'UIA_IsTextPatternAvailablePropertyId', 'UIA_TransformPatternId',
    'UIA_IsItalicAttributeId', 'TreeScope_Descendants',
    'UIA_WindowPatternId', 'UIA_TableRowHeadersPropertyId',
    'AnnotationType_AdvancedProofingIssue', 'StyleId_Heading6',
    'IUIAutomationChangesEventHandler', 'IUIAutomationTextRangeArray',
    'UIA_IsDragPatternAvailablePropertyId',
    'IUIAutomationProxyFactory',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'NotificationProcessing_All', 'WindowInteractionState_Closing',
    'UIA_IsKeyboardFocusablePropertyId', 'IUIAutomationCondition',
    'RowOrColumnMajor', 'StructureChangeType_ChildrenInvalidated',
    'AnnotationType_MoveChange', 'UIA_LegacyIAccessiblePatternId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_DragGrabbedItemsPropertyId', 'WindowVisualState_Maximized',
    'UIA_MenuClosedEventId', 'ProviderOptions', 'TextUnit_Page',
    'ToggleState_On',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_CultureAttributeId', 'UIA_Text_TextChangedEventId',
    'UIA_CenterPointPropertyId', 'IUIAutomationDropTargetPattern',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_Drag_DragCancelEventId', 'TextUnit_Word', 'DockPosition',
    'UIA_InvokePatternId', 'TextEditChangeType_AutoComplete',
    'UIA_RuntimeIdPropertyId', 'TreeScope_Ancestors',
    'NotificationKind_ItemAdded', 'StyleId_NumberedList',
    'UIA_IsRangeValuePatternAvailablePropertyId', 'HeadingLevel9',
    'TextUnit_Document', 'UIA_IsScrollItemPatternAvailablePropertyId',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_DocumentControlTypeId', 'IUIAutomationCacheRequest',
    'UIA_Window_WindowClosedEventId', 'ExpandCollapseState_Expanded',
    'ProviderOptions_ServerSideProvider',
    'TextPatternRangeEndpoint_Start', 'IUIAutomationTableItemPattern',
    'IUIAutomationTransformPattern', 'TextEditChangeType_Composition',
    'IUIAutomationElement9',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_SplitButtonControlTypeId', 'UIA_IsContentElementPropertyId',
    'SynchronizedInputType_KeyUp',
    'UIA_IndentationTrailingAttributeId',
    'UIA_ClickablePointPropertyId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'SynchronizedInputType_RightMouseDown',
    'ProviderOptions_HasNativeIAccessible', 'ZoomUnit_SmallIncrement',
    'UIA_RadioButtonControlTypeId',
    'SynchronizedInputType_RightMouseUp', 'DockPosition_None',
    'StructureChangeType_ChildrenBulkAdded', 'IUIAutomationElement5',
    'CUIAutomation', 'AnnotationType_Author',
    'UIA_ThumbControlTypeId', 'UIA_LocalizedControlTypePropertyId',
    'UIA_DataItemControlTypeId', 'UIA_StrikethroughColorAttributeId',
    'UIA_AnnotationTypesPropertyId', 'IUIAutomationStylesPattern',
    'UIA_IsRequiredForFormPropertyId', 'UIA_AppBarControlTypeId',
    'UIA_StylesFillPatternColorPropertyId',
    'NavigateDirection_NextSibling', 'UIA_SliderControlTypeId',
    'UIA_VirtualizedItemPatternId', 'IUIAutomationTextRange3',
    'WindowInteractionState_NotResponding',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'AnnotationType_Endnote', 'IRawElementProviderSimple',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_HeaderItemControlTypeId',
    'StructureChangeType_ChildrenReordered',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_ToolTipOpenedEventId', 'CoalesceEventsOptions_Disabled',
    'UIA_MarginLeadingAttributeId',
    'AnnotationType_EditingLockedChange',
    'UIA_WindowIsModalPropertyId', 'NotificationKind_ItemRemoved',
    'CoalesceEventsOptions_Enabled', 'TreeScope_Element',
    'UIA_Transform2CanZoomPropertyId',
    'UIA_SayAsInterpretAsAttributeId',
    'UIA_TransformCanResizePropertyId', 'UIA_SpinnerControlTypeId',
    'StructureChangeType_ChildrenBulkRemoved', 'UIA_GridPatternId',
    'UIA_OverlineStyleAttributeId', 'UIA_StatusBarControlTypeId',
    'UIA_TreeItemControlTypeId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_GridColumnCountPropertyId', 'IUIAutomationTextPattern',
    'UIA_AnnotationObjectsPropertyId',
    'IUIAutomationSynchronizedInputPattern',
    'UIA_PositionInSetPropertyId', 'Assertive',
    'UIA_OrientationPropertyId', 'OrientationType_Horizontal',
    'UIA_ControllerForPropertyId', 'UIA_NotificationEventId',
    'WindowInteractionState',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'AnnotationType_ExternalChange', 'UIA_TextPatternId',
    'RowOrColumnMajor_ColumnMajor', 'AnnotationType_Header',
    'IUIAutomationScrollItemPattern', 'UIA_MenuBarControlTypeId',
    'UIA_LevelPropertyId', 'AnnotationType_ConflictingChange',
    'UIA_TreeControlTypeId', 'PropertyConditionFlags_IgnoreCase',
    'IUIAutomationElement4', 'UIA_ItemContainerPatternId',
    'UIA_TitleBarControlTypeId', 'UIA_Window_WindowOpenedEventId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'DockPosition_Top', 'UIA_AnnotationObjectsAttributeId',
    'IUIAutomationTogglePattern',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_FullDescriptionPropertyId', 'UIA_MarginTopAttributeId',
    'UIA_FillColorPropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_AnnotationTypesAttributeId',
    'UIA_SelectionCanSelectMultiplePropertyId', 'UiaChangeInfo',
    'StyleId_Heading3', 'UIA_RangeValueIsReadOnlyPropertyId',
    'StructureChangeType_ChildRemoved',
    'UIA_ToggleToggleStatePropertyId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'AutomationElementMode_None', 'IUIAutomationTablePattern',
    'CoalesceEventsOptions', 'TextPatternRangeEndpoint_End',
    ...
    'UIA_DropTarget_DroppedEventId', 'IUIAutomationGridItemPattern',
    'AnnotationType_FormatChange', 'UIA_TransformPattern2Id',
    'IUIAutomationDockPattern',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_InputReachedOtherElementEventId',
    'UIA_Transform2ZoomMinimumPropertyId', 'UIA_MenuControlTypeId',
    'UIA_ActiveTextPositionChangedEventId', 'UIA_FlowsToPropertyId',
    'StructureChangeType_ChildAdded', 'UIA_FrameworkIdPropertyId',
    'IUIAutomationEventHandler', 'StyleId_Heading5',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_AnnotationPatternId', 'PropertyConditionFlags_None',
    'WindowInteractionState_ReadyForUserInteraction',
    'IUIAutomationAndCondition', 'UIA_RangeValuePatternId',
    'StyleId_Title', 'UIA_LabeledByPropertyId', 'UIA_DragPatternId',
    'UIA_IsActiveAttributeId', 'TextUnit_Character',
    'UIA_AutomationFocusChangedEventId', 'UIA_SystemAlertEventId',
    'UIA_ToolTipClosedEventId', 'SupportedTextSelection',
    'StyleId_Normal', 'UIA_StylesStyleIdPropertyId',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_LegacyIAccessibleSelectionPropertyId', 'HeadingLevel5',
    'UIA_NativeWindowHandlePropertyId', 'ScrollAmount_NoAmount',
    'UIA_HeaderControlTypeId', 'HeadingLevel1',
    'UIA_ListItemControlTypeId', 'UIA_RotationPropertyId',
    'TreeScope_Children', 'UIA_TextControlTypeId',
    'IUIAutomationBoolCondition', 'ExtendedProperty',
    'HeadingLevel_None', 'UIA_Transform2ZoomLevelPropertyId',
    'UIA_WindowWindowVisualStatePropertyId', 'HeadingLevel2',
    'ProviderOptions_ProviderOwnsSetFocus', 'TreeScope_None',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_DragIsGrabbedPropertyId'
]

_check_version('1.2.0', 1702490563.758047)
